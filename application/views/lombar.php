		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<center><h1>Paket Wisata di Lombok Barat</h1>
					<p><h3>Kabupaten Lombok Barat juga memiliki tempat-tempat wisata menarik di Lombok. Berikut ini adalah deretan destinasi wisata populer di Lombok Barat:</h3></p></center><br><br>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							...
							<img src="images/senggigi.jpg" alt="Image" class="img-responsive" width="300" height="150">
						
						<div class="fh5co-text">
							<h2><b>Pantai Senggigi</b></h2>
							...
							<p><a href="FormPelanggan" class="btn btn-primary btn-block">Pilih</a></p>
						</div>
						</figure>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="images/purabatuB.jpg" alt="Image" class="img-responsive" width="300" height="250">
						<div class="fh5co-text">
							<h2><b>Pura Batu Bolong</b></h2>
							...
							<p><a href="FormPelanggan" class="btn btn-primary">Pesan</a></p>
						</div>
						</figure>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<h2><b>Pantai Sekotong</b></h2>
							<img src="images/sekotong.jpg" alt="Image" class="img-responsive" width="300" height="250">
						
						<div class="fh5co-text">
								<p>Price : Rp. 7.000.000,-<br>Duration Tour : 4 Day<br>
								<p>Pantai Sekotong bisa menjadi pilihan tempat wisata menarik berikutnya di Pulau Lombok. Pantai yang berjarak 60 Km dari pusat Kota Mataram ini memiliki keindahan yang membuat siapapun terpukau. Terlebih, pantai ini merupakan pantai yang dikeliling oleh area perbukitan, membuatnya jadi lokasi yang bersih dan jarang terjamah tangan manusia.
							...
							<p><a href="FormPelanggan" class="btn btn-primary">Pilih</p>
						</div>
						</figure>
					</a>
				</div>

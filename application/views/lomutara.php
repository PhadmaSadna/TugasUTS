		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<center><h1>Paket Wisata di Lombok Utara</h1>
					<p><h3>Lombok Utara kerap menjadi persinggahan utama para wisatawan. Alasan utamanya, karena di sini merupakan lokasi dari Gili Trawangan. Namun, apakah hanya ada tempat wisata Gili Trawangan di sini? Berikut ini adalah daftar lokasi wisata populer di Lombok Utara:</h3></p></center><br><br><br>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							...
							<h2><b>Gili Trawangan</b></h2>
							<img src="images/Gtrawangan.jpg" alt="Image" class="img-responsive" width="300" height="250">
						
						<div class="fh5co-text">
								<p>Price : Rp. 9.000.000,-<br>Duration Tour : 4 Day<br> 
								<p>Tempat wisata pertama yang kerap menjadi lokasi liburan di Lombok adalah Gili Trawangan. Pulau yang satu ini menawarkan beragam aktivitas wisata. Anda bisa menyaksikan keindahan alam bawah laut yang memukau, hamparan pasir putih yang luas, ataupun pemandangan matahari terbenam yang mengagumkan.
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<h2><b>Gili Air</b></h2>
							<img src="images/Gair.jpg" alt="Image" class="img-responsive" width="250" height="300">
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<h2><b>Pantai Nipah</b></h2>
							<img src="images/Pnipah.jpg" alt="Image" class="img-responsive" width="300" height="250">
						<div class="fh5co-text">
							<p>Price : Rp. 7.000.000,-<br>Duration Tour : 4 Day<br>
								<p>Berada tidak jauh dari Pantai Senggigi, Pantai Nipah bisa menjadi tempat wisata yang masuk dalam daftar kunjungan Anda di Lombok. Dari Senggigi, Anda hanya butuh waktu perjalanan selama 20 menit. Perjalanan pun akan terasa menyenangkan, karena ditemani oleh pemandangan area bukit yang hijau.

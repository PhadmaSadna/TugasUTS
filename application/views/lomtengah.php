		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<center><h1>Paket Wisata di Lombok Tengah</h1>
					<p><h3>Kabupaten Lombok Tengah menjadi wilayah yang penuh dengan tempat wisata menarik. Berikut ini adalah beberapa daftar lokasi wisata populer yang ada di Lombok Tengah:</h3></p></center><br><br><br>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							...
							<h2><b>Pantai Seger</b></h2>
							<img src="images/Pseger.jpg" alt="Image" class="img-responsive" width="300" height="250">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<h2><b>Desa Sade</b></h2>
							<img src="images/Dsade.jpg" alt="Image" class="img-responsive" width="250" height="300">
						<div class="fh5co-text">
							<p>Price : Rp. 5.000.000,-<br>Duration Tour : 4 Day<br>
							<p>Tempat wisata berikutnya yang berada tidak jauh dari Desa Kuta adalah Desa Sade. Di sini, Anda akan bisa menyaksikan secara langsung kehidupan Suku Sasak yang dikenal sebagai penduduk asli Pulau Lombok. Masyarakat yang tinggal di Desa Sade pun masih terus berusaha untuk melestarikan budaya yang diturunkan secara turun temurun.
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<h2><b>Bukit Merese</b></h2>
							<img src="images/Bmerese.jpg" alt="Image" class="img-responsive" width="300" height="250">
						<div class="fh5co-text">

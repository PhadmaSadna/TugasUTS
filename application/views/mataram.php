		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<center><h1>Paket Wisata di Mataram</h1>
					<p><h3>Kota Mataram kerap menjadi persinggahan utama kala di Pulau Lombok. Berikut ini adalah deretan tempat wisata yang bisa dikunjungi di wilayah Kota Mataram:</h3></p></center><br><br><br>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							...
							<h2><b>Pura Taman Mayura</b></h2>
							<img src="images/puratamay.jpg" alt="Image" class="img-responsive" width="300" height="250">
						
						<div class="fh5co-text">
								<p>Price : Rp. 9.000.000,-<br>Duration Tour : 4 Day<br> 
								<p>Tempat wisata Pura Taman Mayura yang berada di Cakranegara memang dikenal sebagai area bersejarah di Kota Mataram. Utamanya, karena tempat ini adalah koloni dari Kerajaan Karangasem Bali.
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<h2><b>Pura Meru</b></h2>
							<img src="images/purameru.jpg" alt="Image" class="img-responsive" width="250" height="300">
						<div class="fh5co-text">
